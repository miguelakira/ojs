<?php return array (
  ...
  'submission.event.logLevel' => 'Nível',
  'submission.event.logLevel.info' => 'Informação',
  'submission.event.logLevel.notice' => 'Aviso',
  'submission.event.logLevel.warning' => 'Advertência',
  'submission.event.logLevel.error' => 'Erro',
...
<br /><br />
<a href="http://www.pkp.ubc.ca/harvester/add.php" target="_blank">Clique aqui</a> e insira <span class="highlight">{$siteUrl}</span> no campo <strong>URL do Portal</strong>, e <span class="highlight">{$oaiUrl}</span> no campo <strong>URL Base para o Arquivo OAI</strong>.
<br /><br />
...
<ul>
  ...
  'admin.editSystemConfigInstructions' => 'Utilize o formulário para modificar as configurações do sistema (o documento <tt>config.inc.php</tt>). Clique em "Salvar" para concluir as alterações de configuração, ou "Exibir" para apenas mostrar as configurações atualizadas sem realizar as modificações.
<br /><br />
<span class="formError">Advertência: Alterações nas configurações podem deixar o portal inacessível (obrigando a alterar manualmente o arquivo). É altamente recomendado que as alterações sejam realizadas por um especialista.</span>',
...
<br /><br />
<a href="http://www.pkp.ubc.ca/harvester/add.php" target="_blank">Clique aqui</a> e digite <span class="highlight">{$siteUrl}</span> no campo <strong>Site URL</strong>, e <span class="highlight">{$oaiUrl}</span> no campo <strong>Base URL for OAI Archive</strong>.',
...
(Após salvar, outros comentários podem ser incluídos.)',
  ...
  'user.register.repeatPassword' => 'Repetir senha',
...
<li>Use <strong>*</strong> como caracter coringa; ex.: <em>soci* moralidade</em> recuperará documentos contendo "sociedade" ou "sociológico"</li>
  ...
  'about.aboutOJSJournal' => 'A revista usa o Open Journal Systems (OJS {$ojsVersion}), sistema de código livre gratuito para a administração e a publicação de revistas, desenvolvido com suporte e distribuição pelo <a href="http://www.pkp.ubc.ca/">Public Knowledge Project</a> sob a licença GNU General Public License.',
  'about.aboutOJSSite' => 'O portal utiliza o Open Journal Systems (OJS {$ojsVersion}), sistema de código livre gratuito para a administração e a publicação de revistas desenvolvido com suporte e distribuição  pelo <a href="http://www.pkp.ubc.ca/">Public Knowledge Project</a> sob a licença GNU General Public License.',
  'help.ojsHelp' => 'Ajuda?',
...
<p>Escolha a opção <strong>Instalação Manual</strong> para exibir os comandos SQL necessários para criar o esquema da base de dados do sistema e inserir dados iniciais e executar a instalação manual. Esta opção é útil para verificação de erros na instalação, particularmente para plataformas não suportadas. Note que o método manual não tentará criar a base ou as tabelas, embora o documento de configuração possua as configurações necessárias para tal.</p>',
  'installer.upgradeInstructions' => '<h4>Versão {$version}</h4>

<p>Agradecemos seu interesse em utilizar o <strong>Open Journal Systems</strong>, desenvolvido pelo Public Knowledge Project. Antes de continuar, leia o documento <a href="{$baseUrl}/docs/README_pt">README_pt</a> e o <a href="{$baseUrl}/docs/UPGRADE_pt">UPGRADE_pt</a>incluído com o pacote. Para maiores informações sobre o Public Knowledge Project e outros sistemas desenvolvidos, acesse o <a href="http://www.pkp.ubc.ca/" target="_blank">portal do PKP</a>. Clique em <href="http://www.ibict.br" target="_blank">portal do Ibict/MCT</a> e em <a href="http://seer.ibict.br/" target="_blank">portal do SEER</a>para maiores informações sobre o envolvimento do Instituto Brasileiro de Informação em Ciência e Tecnologia com o sistema. Para reportar erros, sugestões ou dúvidas sobre o Open Journal Systems visite o <a href="pkp.sfu.ca/support/forum">PKP Support Forum</a>, ou <a href="http://www.pkp.ubc.ca/bugzilla/" target="_blank">Sistema de Controle de erros Bugzilla</a> do PKP. Embora os fóruns sejam a forma preferencial de contato, também pode-se entrar em contato com a Equipe do SEER por meio dos formulários disponíveis na seção <a href="http://seer.ibict.br/index.php?option=com_content&task=view&id=270&Itemid=113" target="_blank">Fale conosco</a> no <a href="http://seer.ibict.br" target="_blank">portal do SEER</a> e para a <a href="mailto:pkp.contact@gmail.com">Equipe do PKP (pkp.contact@gmail.com)</a>.</p>
...
<p>O instalador não pode sobrescrever o documento de configuração. Antes de usar o sistema, edite o documento <tt>config.inc.php</tt> em um editor de texto e substitua todo o conteúdo pelo texto apresentado no campo a seguir.</p>',
  'installer.manualSQLInstructions' => '<h4>Instalação Manual</h4>
<p>Seguem os comandos SQL para criar o esquema da base de dados e inclusão de dados iniciais. Note que o sistema não poderá ser usado até a execução manual dos comandos. Será necessário também configurar manualmente o documento <tt>config.inc.php</tt>.</p>',
...
<ol>
  ...
  'rt.metadata.pkp.doi' => 'Identificador de Objeto Digital (DOI)',
...
Pode-se opcionalmente informar o motivo pelo qual está sendo desativado o cadastro.',
  ...
  'notification.type.articleSubmitted' => 'Um novo artigo, "{$param}", foi submetido.',
  'notification.type.copyeditComment' => 'O Editor de Texto fez um comentário sobre ""{$param}".',
  'notification.type.editing' => 'Editando eventos',
  'notification.type.editorDecisionComment' => 'Um comentário foi feito sobre a decisão editorial de "{$param}".',
  'notification.type.galleyModified' => 'A versão para publicação foi alterada para "{$param}".',
  'notification.type.issuePublished' => 'Uma nova edição foi publicada.',
  'notification.type.layoutComment' => 'Um comentário foi feito sobre o layout de "{$param}".',
  ...
  'notification.type.proofreadComment' => 'Um comentário foi feito pelo leitor de provas sobre "{$param}".',
  'notification.type.reviewerComment' => 'Um avaliador fez comentários sobre "{$param}".',
  ...
  'notification.type.submissionComment' => 'Um editor fez comentários sobre "{$param}".',
  'notification.type.submissions' => 'Eventos da Submissão',
  'notification.type.suppFileModified' => 'Arquivo(s) suplementar(es) de "{$param}" foram alterados.',
  'notification.type.userComment' => 'Um leitor comentou sobre "{$param}".',
