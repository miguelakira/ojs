<?php return array (
  ...
  'admin.mergeUsers.confirm' => 'Deseja realmente mesclar o cadastro do usuário "{$oldUsername}" no cadastro do usuário "{$newUsername}"? O cadastro de "{$oldUsername}" será excluído permanentemente. Esta ação é irreversível!',
