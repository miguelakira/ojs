<?php return array (
  ...
  'author.submit.stepsToSubmit' => '5 Passos para a submissão',
  ...
  'author.submit.cancelSubmission' => 'A submissão pode ser concluída em uma data posterior, clicando em Submissões Ativas nas opções da sua página de autor.',
  ...
  'author.submit.qualityForWaiver' => 'Solicito considerar isenção de Taxa de Submissão para este artigo',
  ...
  'author.submit.howToSubmitNoPhone' => 'Em caso de dificuldades com o processo, entre em contato com <a href="mailto:{$supportEmail}">{$supportName}</a> via e-mail para suporte.',
  'author.submit.journalSection' => 'Seção',
  'author.submit.journalSectionDescription' => 'Escolha a seção apropriada para a submissão (leia Seções e Políticas na página <a href="{$aboutUrl}">Sobre</a> a revista).',
  'author.submit.selectSection' => 'Escolha uma seção...',
  'author.submit.submissionChecklist' => 'Condições para submissão',
  'author.submit.submissionChecklistDescription' => 'Confirme que a submissão está em conformidade com as condições seguintes, marcando as caixas de seleção, para prosseguir ao Passo 2 do processo.',
  'author.submit.verifyChecklist' => 'Todas as condições devem ser satisfeitas antes de continuar.',
  'author.submit.copyrightNoticeAgree' => 'Os autores concordam com os termos da Declaração de Direito Autoral, que se aplicará a esta submissão caso seja publicada nesta revista (comentários ao editor podem ser incluídos a seguir).',
  'author.submit.copyrightNoticeAgreeRequired' => 'É obrigatório aceitar a Declaração de Direito Autoral para continuar!',
  'author.submit.commentsForEditor' => 'Comentários para o editor',
  'author.submit.comments' => 'Digite o texto (opcional)',
  'author.submit.form.sectionRequired' => 'Escolha a seção apropriada para a submissão.',
  ...
  'author.submit.form.abstractRequired' => 'Informe o resumo do documento',
  ...
  'author.submit.confirmationDescription' => 'Após concluídos e verificados os passos anteriores, clique em "Concluir submissão" para enviar seu trabalho para a revista {$journalTitle}. Um e-mail de confirmação será enviado. Acompanhe a situação da submissão, dentro do processo editorial da revista, acessando o sistema com o papel de autor. Agradecemos seu interesse em contribuir com seu trabalho para a revista {$journalTitle}.',
  ...
  'author.submit.expedite' => 'Caso a submissão já esteja em um formato pronto para publicação, sem a necessidade de revisão, edição ou layout, ela pode ser enviada diretamente para o último passo, a Edição da submissão <a href="{$expediteUrl}" class="action">clicando aqui!</a>. (Aviso: Apenas Editores da revista possuem esta opção para suas submissões.)',
  ...
  'author.submit.submissionLocale' => 'Idioma da submissão',
  'author.submit.form.localeRequired' => 'Escolha um idioma para a submissão.',
  'author.submit.submissionLocaleDescription' => 'Este periódico aceita submissões em vários idiomas. Escolha o idioma principal da submissão a partir do menu dropdown a seguir.',
); ?>