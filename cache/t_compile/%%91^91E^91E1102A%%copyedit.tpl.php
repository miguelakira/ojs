<?php /* Smarty version 2.6.26, created on 2011-02-17 06:17:38
         compiled from author/submission/copyedit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submission/copyedit.tpl', 12, false),array('function', 'url', 'author/submission/copyedit.tpl', 25, false),array('function', 'icon', 'author/submission/copyedit.tpl', 60, false),array('modifier', 'escape', 'author/submission/copyedit.tpl', 18, false),array('modifier', 'date_format', 'author/submission/copyedit.tpl', 34, false),array('modifier', 'default', 'author/submission/copyedit.tpl', 34, false),array('modifier', 'to_array', 'author/submission/copyedit.tpl', 43, false),array('modifier', 'assign', 'author/submission/copyedit.tpl', 62, false),)), $this); ?>
<div id="copyedit">
...
:
			<?php if ($this->_tpl_vars['copyeditInitialSignoff']->getDateCompleted() && $this->_tpl_vars['initialCopyeditFile']): ?>
				<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['copyeditInitialSignoff']->getFileId(), $this->_tpl_vars['copyeditInitialSignoff']->getFileRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['copyeditInitialSignoff']->getFileId(), $this->_tpl_vars['copyeditInitialSignoff']->getFileRevision()))), $this);?>
...
:
			<?php if ($this->_tpl_vars['copyeditAuthorSignoff']->getDateNotified() && $this->_tpl_vars['editorAuthorCopyeditFile']): ?>
				<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['copyeditAuthorSignoff']->getFileId(), $this->_tpl_vars['copyeditAuthorSignoff']->getFileRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['copyeditAuthorSignoff']->getFileId(), $this->_tpl_vars['copyeditAuthorSignoff']->getFileRevision()))), $this);?>
...
:
			<?php if ($this->_tpl_vars['copyeditFinalSignoff']->getDateCompleted() && $this->_tpl_vars['finalCopyeditFile']): ?>
				<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['copyeditFinalSignoff']->getFileId(), $this->_tpl_vars['copyeditFinalSignoff']->getFileRevision()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['copyeditFinalSignoff']->getFileId(), $this->_tpl_vars['copyeditFinalSignoff']->getFileRevision()))), $this);?>
...
<?php if ($this->_tpl_vars['submission']->getMostRecentCopyeditComment()): ?>
	...
	<a href="javascript:openComments('<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'viewCopyeditComments','path' => $this->_tpl_vars['submission']->getArticleId(),'anchor' => $this->_tpl_vars['comment']->getId()), $this);?>
