<?php /* Smarty version 2.6.26, created on 2011-02-08 23:35:18
         compiled from editor/issues/issueToc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'editor/issues/issueToc.tpl', 13, false),array('modifier', 'truncate', 'editor/issues/issueToc.tpl', 44, false),array('modifier', 'assign', 'editor/issues/issueToc.tpl', 57, false),array('modifier', 'strip_unsafe_html', 'editor/issues/issueToc.tpl', 99, false),array('function', 'url', 'editor/issues/issueToc.tpl', 26, false),array('function', 'translate', 'editor/issues/issueToc.tpl', 34, false),array('function', 'html_options', 'editor/issues/issueToc.tpl', 44, false),array('function', 'call_hook', 'editor/issues/issueToc.tpl', 53, false),array('function', 'icon', 'editor/issues/issueToc.tpl', 110, false),)), $this); ?>
...
?>
	...
	<tr id="article-<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getPubId())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" class="data">
		<td><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveArticleToc','d' => 'u','id' => $this->_tpl_vars['article']->getPubId()), $this);?>
" class="plain">&uarr;</a>&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveArticleToc','d' => 'd','id' => $this->_tpl_vars['article']->getPubId()), $this);?>
...
" class="action"><?php endif; ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 60, "...")); ?>
...
]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getPublicArticleId())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
