<?php /* Smarty version 2.6.26, created on 2011-02-09 04:09:03
         compiled from editor/issues/issueData.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'editor/issues/issueData.tpl', 19, false),array('function', 'translate', 'editor/issues/issueData.tpl', 19, false),array('function', 'html_options', 'editor/issues/issueData.tpl', 27, false),array('function', 'fieldLabel', 'editor/issues/issueData.tpl', 51, false),array('function', 'form_language_chooser', 'editor/issues/issueData.tpl', 54, false),array('function', 'math', 'editor/issues/issueData.tpl', 97, false),array('function', 'html_select_date', 'editor/issues/issueData.tpl', 99, false),array('modifier', 'escape', 'editor/issues/issueData.tpl', 27, false),array('modifier', 'assign', 'editor/issues/issueData.tpl', 53, false),array('modifier', 'date_format', 'editor/issues/issueData.tpl', 95, false),array('modifier', 'to_array', 'editor/issues/issueData.tpl', 146, false),)), $this); ?>
...
<form name="issue" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editIssue','path' => $this->_tpl_vars['issueId']), $this);?>
...
&nbsp;&nbsp;
								<?php $this->assign('publishedYear', ((is_array($_tmp=$this->_tpl_vars['issue']->getDatePublished())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y") : smarty_modifier_date_format($_tmp, "%Y"))); ?>
				...
				<?php echo smarty_function_html_select_date(array('prefix' => 'datePublished','time' => $this->_tpl_vars['datePublished'],'all_extra' => "class=\"selectMenu\"",'start_year' => $this->_tpl_vars['minYear'],'end_year' => $this->_tpl_vars['maxYear']), $this);?>
...
<?php if (( $this->_tpl_vars['currentJournal']->getSetting('publishingMode') == @PUBLISHING_MODE_SUBSCRIPTION && ! $this->_tpl_vars['enableDelayedOpenAccess'] ) || ( $this->_tpl_vars['currentJournal']->getSetting('publishingMode') == @PUBLISHING_MODE_SUBSCRIPTION && $this->_tpl_vars['enableDelayedOpenAccess'] && $this->_tpl_vars['issue']->getPublished() )): ?>
<div class="separator"></div>
<div id="issueAccess">
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="checkbox" id="enableOpenAccessDate" name="enableOpenAccessDate" <?php if ($this->_tpl_vars['openAccessDate']): ?>checked="checked" <?php endif; ?>onchange="document.issue.openAccessDateMonth.disabled=this.checked?false:true;document.issue.openAccessDateDay.disabled=this.checked?false:true;document.issue.openAccessDateYear.disabled=this.checked?false:true;" />&nbsp;<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'enableOpenAccessDate','key' => "editor.issues.enableOpenAccessDate"), $this);?>
<br/>
			<?php if ($this->_tpl_vars['openAccessDate']): ?>
...
</a>&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'removeCoverPage','path' => ((is_array($_tmp=$this->_tpl_vars['issueId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['formLocale']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['formLocale']))), $this);?>
