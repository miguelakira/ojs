<?php /* Smarty version 2.6.26, created on 2011-02-09 04:06:00
         compiled from user/register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'user/register.tpl', 21, false),array('modifier', 'assign', 'user/register.tpl', 34, false),array('modifier', 'nl2br', 'user/register.tpl', 241, false),array('function', 'url', 'user/register.tpl', 28, false),array('function', 'translate', 'user/register.tpl', 30, false),array('function', 'fieldLabel', 'user/register.tpl', 58, false),array('function', 'form_language_chooser', 'user/register.tpl', 61, false),array('function', 'html_options_translate', 'user/register.tpl', 134, false),array('function', 'html_options', 'user/register.tpl', 187, false),)), $this); ?>
...
?>"<?php echo ((is_array($_tmp=$this->_tpl_vars['interest'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'javascript')); ?>
