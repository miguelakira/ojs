<?php /* Smarty version 2.6.26, created on 2011-02-08 23:32:44
         compiled from manager/people/userProfileForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/people/userProfileForm.tpl', 12, false),array('function', 'translate', 'manager/people/userProfileForm.tpl', 63, false),array('function', 'fieldLabel', 'manager/people/userProfileForm.tpl', 97, false),array('function', 'form_language_chooser', 'manager/people/userProfileForm.tpl', 100, false),array('function', 'html_options_translate', 'manager/people/userProfileForm.tpl', 125, false),array('function', 'html_options', 'manager/people/userProfileForm.tpl', 163, false),array('modifier', 'assign', 'manager/people/userProfileForm.tpl', 12, false),array('modifier', 'escape', 'manager/people/userProfileForm.tpl', 22, false),array('modifier', 'urldecode', 'manager/people/userProfileForm.tpl', 233, false),)), $this); ?>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#interests").tagit({
			'; ?>
<?php if ($this->_tpl_vars['existingInterests']): ?><?php echo ' availableTags: ['; ?>
...
<?php endif; ?>
			<?php if ($this->_tpl_vars['currentInterests']): ?><?php echo 'currentTags: ['; ?>
<?php $_from = $this->_tpl_vars['currentInterests']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['currentInterests'] = array('total' => count($_from), 'iteration' => 0);
...
" size="15" maxlength="24" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('key' => "user.interests"), $this);?>
</td>
