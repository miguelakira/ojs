...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'article/googlescholar.tpl', 12, false),array('modifier', 'escape', 'article/googlescholar.tpl', 12, false),array('modifier', 'date_format', 'article/googlescholar.tpl', 22, false),array('modifier', 'explode', 'article/googlescholar.tpl', 36, false),array('modifier', 'String_substr', 'article/googlescholar.tpl', 38, false),array('modifier', 'to_array', 'article/googlescholar.tpl', 44, false),array('function', 'url', 'article/googlescholar.tpl', 31, false),)), $this); ?>
...
"/>
<?php endif; ?>
	<meta name="citation_authors" content="<?php $_from = $this->_tpl_vars['article']->getAuthors(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['authors'] = array('total' => count($_from), 'iteration' => 0);
...
<?php endif; ?><?php if (! ($this->_foreach['authors']['iteration'] == $this->_foreach['authors']['total'])): ?>; <?php endif; ?><?php endforeach; endif; unset($_from); ?>"/>
...
"/>
	<meta name="citation_date" content="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getDatePublished())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
"/>
...
<?php if ($this->_tpl_vars['article']->getPages()): ?>
	<meta name="citation_firstpage" content="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getPages())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"/>
<?php endif; ?>
<?php if ($this->_tpl_vars['article']->getDOI()): ?>
	<meta name="citation_doi" content="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getDOI())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"/>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['gs_galley']->getFileType() == "application/pdf"): ?>
	<meta name="citation_pdf_url" content="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => ((is_array($_tmp=$this->_tpl_vars['article']->getBestArticleId($this->_tpl_vars['currentJournal']))) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['gs_galley']->getBestGalleyId($this->_tpl_vars['currentJournal'])) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['gs_galley']->getBestGalleyId($this->_tpl_vars['currentJournal'])))), $this);?>
"/>
<?php else: ?>
