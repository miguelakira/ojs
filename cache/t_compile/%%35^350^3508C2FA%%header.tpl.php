<?php /* Smarty version 2.6.26, created on 2011-02-17 07:01:39
         compiled from article/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'article/header.tpl', 16, false),array('modifier', 'strip_tags', 'article/header.tpl', 18, false),array('modifier', 'assign', 'article/header.tpl', 37, false),array('modifier', 'to_array', 'article/header.tpl', 111, false),array('function', 'call_hook', 'article/header.tpl', 27, false),array('function', 'translate', 'article/header.tpl', 87, false),array('function', 'url', 'article/header.tpl', 100, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<head>
	<title><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 | <?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getFirstAuthor(true))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<img class = "displayed" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/lib/pkp/styles/images/logo.png" border="0" >
<h1>
