<?php /* Smarty version 2.6.26, created on 2011-02-17 19:26:50
         compiled from issue/issue.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'issue/issue.tpl', 12, false),array('modifier', 'strip_unsafe_html', 'issue/issue.tpl', 41, false),array('modifier', 'to_array', 'issue/issue.tpl', 45, false),array('function', 'url', 'issue/issue.tpl', 22, false),array('function', 'translate', 'issue/issue.tpl', 23, false),array('function', 'call_hook', 'issue/issue.tpl', 26, false),)), $this); ?>
...
"<?php endif; ?>/></a></div>
	...
	<td class="tocTitle"><?php if (! $this->_tpl_vars['hasAccess'] || $this->_tpl_vars['hasAbstract']): ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['articlePath']), $this);?>
...
<tr>
	<td class="tocAuthors">
		<?php if (( ! $this->_tpl_vars['section']['hideAuthor'] && $this->_tpl_vars['article']->getHideAuthor() == 0 ) || $this->_tpl_vars['article']->getHideAuthor() == 2): ?>
...
<?php if (! ($this->_foreach['authorList']['iteration'] == $this->_foreach['authorList']['total'])): ?>,<?php endif; ?>
	...
	<td class="tocPages"><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getPages())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
</tr>
</table>
<?php endforeach; endif; unset($_from); ?>
