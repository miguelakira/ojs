<?php /* Smarty version 2.6.26, created on 2011-02-17 06:22:32
         compiled from sectionEditor/submissionHistory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submissionHistory.tpl', 13, false),array('function', 'url', 'sectionEditor/submissionHistory.tpl', 50, false),array('function', 'icon', 'sectionEditor/submissionHistory.tpl', 85, false),array('modifier', 'assign', 'sectionEditor/submissionHistory.tpl', 13, false),array('modifier', 'date_format', 'sectionEditor/submissionHistory.tpl', 80, false),array('modifier', 'escape', 'sectionEditor/submissionHistory.tpl', 81, false),array('modifier', 'concat', 'sectionEditor/submissionHistory.tpl', 83, false),array('modifier', 'to_array', 'sectionEditor/submissionHistory.tpl', 84, false),array('modifier', 'translate', 'sectionEditor/submissionHistory.tpl', 84, false),array('modifier', 'strip_unsafe_html', 'sectionEditor/submissionHistory.tpl', 90, false),array('modifier', 'truncate', 'sectionEditor/submissionHistory.tpl', 90, false),array('modifier', 'nl2br', 'sectionEditor/submissionHistory.tpl', 175, false),array('block', 'iterate', 'sectionEditor/submissionHistory.tpl', 78, false),)), $this); ?>
<?php echo ''; ?><?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.page.history",'id' => $this->_tpl_vars['submission']->getArticleId()), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'pageTitleTranslated') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'pageTitleTranslated'));?><?php echo ''; ?><?php $this->assign('pageCrumbTitle', "submission.history"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
