...
<?php if ($this->_tpl_vars['submission']->getMostRecentProofreadComment()): ?>
        ...
        <a href="javascript:openComments('<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'viewProofreadComments','path' => $this->_tpl_vars['submission']->getArticleId(),'anchor' => $this->_tpl_vars['comment']->getId()), $this);?>
