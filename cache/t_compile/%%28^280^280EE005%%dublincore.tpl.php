...
<?php if ($this->_tpl_vars['issue']->getOpenAccessDate()): ?>
...
<?php if ($this->_tpl_vars['article']->getDOI()): ?>
	<meta name="DC.Identifier.DOI" content="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getDOI())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"/>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('copyrightNotice')): ?>
	<meta name="DC.Rights" content="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('copyrightNotice'))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"/>
<?php endif; ?>
