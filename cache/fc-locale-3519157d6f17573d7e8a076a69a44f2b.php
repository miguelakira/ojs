<?php return array (
  ...
  'manager.sections.confirmDelete' => 'Deseja realmente excluir permanentemente esta seção? Os artigos desta seção deverão ser publicados novamente.',
...
&lt;meta name="DC.title" content="Título da revista" /&gt;',
  ...
  'manager.setup.doiPrefixDescription' => 'O prefixo DOI (Digital Object Identifier) é controlado e oferecido por <a href="http://www.crossref.org" target="_new">CrossRef</a> e possui o formato 10.xxxx (ex.: 10.1234).',
  ...
  'manager.setup.submissionEmailLogging' => 'Manter log de todos os e-mails enviados relativos à submissão na página Histórico.',
  'manager.setup.submissionEventLogging' => 'Manter log de todas as ações tomadas sobre a submissão na página Histórico.',
  ...
  'manager.setup.doiSuffix' => 'Suffixo DOI',
  'manager.setup.doiSuffixDefault' => 'Usar padrão (%j.v%vi%i.%a).',
  'manager.setup.doiSuffixPattern' => 'Use o padrão informado abaixo para gerar sufixos DOI. Use %j para iniciais da revista, %v para o volume, %i para a edição, %a para o código do artigo no sistema e %p para o número da página.',
  'manager.setup.doiSuffixPattern.example' => 'Por exemplo, vl%viss%ipp%p poderia criar um DOI to tipo 10.1234/vol3iss2pp230',
  'manager.setup.doiSuffixDescription' => 'Um sufixo DOI pode possuir qualquer formato, desde que seja único para cada item publicado.',
  'manager.setup.doiSuffixCustomIdentifier' => 'Usar o "Identificador personalizado" para itens publicados como sufixo DOI (deve estar habilitado no Passo 4).',
  'manager.setup.form.doiPrefixPattern' => 'O padrão DOI deve estar no formato 10.xxxx.',
  ...
  'manager.setup.doiReassign' => 'Designar DOIs novamente',
  ...
  'manager.setup.doiReassign.description' => 'Caso altere suas configurações de DOI, os já designados não serão afetados. Uma vez que a configuração for salva, use este botão para limpar todos os DOIs para que as novas configurações tenham efeito nos artigos existentes.',
); ?>